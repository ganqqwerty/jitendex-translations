...
README-DEMO-2 — The [frequency analysis](https://ganqqwerty.github.io/jp-ru-kolobok-dictionary/frequency/) shows the source-list coverage used to plan translation scopes.
